...
if uploaded_file is not None:
    ...
    def run_pycaret(data, task, input_col, input_ex):
        if task == "Classification":
            ...
            from pycaret.classification import setup, create_model, compare_models, tune_model, plot_model
            ...
            from pycaret.regression import setup, create_model, compare_models, tune_model, plot_model
